...
@Component({
  selector: 'srca-contact-center-detail',
  templateUrl: './contact-center-details.component.html',
  styleUrls: ['./contact-center-details.component.scss']
})
export class ContactCenterDetailsComponent implements OnInit, OnChanges, OnDestroy, TaskDetailComponent {
